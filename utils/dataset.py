...
class CamObjDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        return image, gt, grad, edge, image_max1, image_max2, image_max3, image_max4, image_max5, image_min1, image_min2, image_min3, image_min4, image_min5, range1, range2, range3, range4
